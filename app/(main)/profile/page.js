...
const activityData = [
  ...
  {
    id: 2,
    description: "Menambahkan aset baru: Laptop Dell XPS 15.",
    time: "3 jam yang lalu",
    icon: "add",
  },
  {
    id: 3,
    description: "Memperbarui status perawatan untuk Mobil #B1234XYZ.",
    time: "Kemarin",
    icon: "update",
  },
  {
    id: 4,
    description: "Menghasilkan laporan aset bulanan.",
    time: "Kemarin",
    icon: "report",
  },
  {
