        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input name="title" type="text" placeholder="Masukkan judul item" required className="w-full p-2 border rounded" />
                </div>
            </div>
            <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Deskripsi</label>
                <textarea name="description" placeholder="Jelaskan detail item" className="w-full p-2 border rounded h-24"></textarea>
            </div>
