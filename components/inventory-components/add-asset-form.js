...
export default function AddAssetForm({ onClose }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 mt-4">
      <div>
        <label className="block text-sm font-medium text-gray-700">No Aset</label>
        <input
          type="text"
          name="assetNumber"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700">Title Aset</label>
        <input
          type="text"
          name="assetName"
      ...
      <div>
        ...
        <select
          ...
          className="mt-1 block w-full rounded-md border border-gray-400 bg-gray-100 shadow-sm p-2 focus:outline-none focus:border-gray-600"
        >
          {["General", "Chief", "Strategic", "Creative", "Marketing", "Brand", "Commercial Business", "HCGA", "SCM", "PID", "IT", "Retail", "Finance"].map((div) => (
